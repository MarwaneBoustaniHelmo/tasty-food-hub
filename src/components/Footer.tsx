    ...
    <footer className="bg-card border-t border-border">
      ...
      <div className="container py-8 md:py-12 px-4">
        ...
        <div className="md:hidden space-y-6">
          ...
          <div className="flex justify-center gap-3">
            {socialLinks.map((social) => (
              ...
              >
                <span className={social.textColor || "text-white"}>{social.icon}</span>
              </a>
            ))}
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              {socialLinks.map((social) => (
                ...
                >
                  <span className={social.textColor || "text-white"}>{social.icon}</span>
                  <span className={`text-xs font-medium ${social.textColor || "text-white"}`}>{social.name}</span>
                </a>
              ))}
            </div>
            <p className="text-xs text-muted-foreground">
        ...
        <p className="text-center text-xs text-muted-foreground/50 mt-4">
          Site développé avec passion pour les amateurs de smash burgers 🍔
        </p>
      </div>
    </footer>
  );
