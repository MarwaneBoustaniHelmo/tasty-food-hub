...
export const restaurantsMenu: RestaurantMenu[] = [
  ...
  },
  {
    ...
    description: "Smash burgers halal et street food premium à Angleur. Commander sur Takeaway ou via notre site tastyfoodangleur.be.",
    welcomeMessage: "Bienvenue chez Tasty Food Angleur ! 🌟 Commandez via nos plateformes de livraison.",
    categories: commonCategories,
    platforms: [
