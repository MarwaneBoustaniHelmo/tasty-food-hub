      ...
      <div className="container px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-12 max-w-5xl mx-auto">
          ...
          <div className="space-y-4 md:space-y-6">
            <h2 className="font-display text-2xl md:text-3xl text-primary">NOS ADRESSES</h2>
          ...
          <div className="space-y-4 md:space-y-6">
            ...
            <p className="text-muted-foreground text-sm">
              Suivez nos aventures gourmandes, découvrez nos nouveaux burgers et bénéficiez d'offres exclusives !
            </p>
            ...
            <div className="grid grid-cols-2 gap-3">
              {socialLinks.map((social) => (
                ...
                >
                  ...
                  <ExternalLink size={14} className={social.name === "Snapchat" ? "text-black/70" : "text-white/70"} />
                </a>
              ))}
            </div>
